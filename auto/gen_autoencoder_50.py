...
def autoencoder():
    ...
    base_performance_result_dir = "/Users/xuyingwangswift/Desktop/AE_FEA/Results"
    factor_dir = '/Users/xuyingwangswift/Desktop/AE_FEA/Factors/'
    ...
    for i, (func, bounds) in enumerate(benchmark_functions):
        ...
        performance_result_file = function_name + '_auto_data_dim_50_gen_50000_result.csv'
        autofacors = function_name + '_dim50_autofactor.csv'
