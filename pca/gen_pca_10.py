...
def pca():
    ...
    base_performance_result_dir = "/Users/xuyingwangswift/Desktop/FEA_PCA_AUTOENCODER/src/Results/PCA_abs_dim10"
    ...
    for i, (func, bounds) in enumerate(benchmark_functions):
        ...
        performance_result_file = function_name + '_abs_pca_data_dim_10_gen_10000_result.csv'
        max_threshold_factors_file = function_name + '_abs_dim10_threshold.csv'
