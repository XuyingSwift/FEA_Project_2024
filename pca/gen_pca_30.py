from FEA.PCA.pca_grouping import run_pca_fea_process
...
def pca():
    ...
    base_performance_result_dir = "/Users/xuyingwangswift/Desktop/FEA_PCA_AUTOENCODER/src/Results/PCA_abs_dim30"
    threshold_dir = '/Users/xuyingwangswift/Desktop/FEA_PCA_AUTOENCODER/src/Results/Abs_threshold/'
    ...
    function_name = "schwefel_2_20"       
    fcn_num = 15 # Assuming the function number is its position in the list
    lb = -100
    ub = 100

        # Define file paths
    data_file_path = base_data_path + function_name + ".csv"
    performance_result_file = function_name + '_abs_pca_data_dim_30_gen_25000_result.csv'
    max_threshold_factors_file = function_name + '_abs_dim30_threshold.csv'
