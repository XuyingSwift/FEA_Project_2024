...
def pca():
    ...
    base_performance_result_dir = "/Users/xuyingwangswift/Desktop/FEA_PCA_AUTOENCODER/src/Results/PCA_abs_dim50"
    ...
    fcn_num = 19 # Assuming the function number is its position in the list
    lb = -5
    ub = 10

        # Define file paths
    data_file_path = base_data_path + function_name + ".csv"
    performance_result_file = function_name + '_abs_pca_data_dim_50_gen_50000_result.csv'
    max_threshold_factors_file = function_name + '_abs_dim50_threshold.csv'
