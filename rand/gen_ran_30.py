from FEA.factors.classic_random_grouping import run_random_fea_process
from FEA.factors.pca_grouping import run_pca_fea_process
...
def random_fea():
    print(PINK + f"Radom 30 processing ....")
    ...
    for i, (func, bounds) in enumerate(benchmark_functions):
        ...
        lb, ub = bounds
        # Define file paths
        performance_result_file = function_name + '_random_data_dim30_gen_25000_result.csv'
        ...
        print(PINK + f"Random 30 Completed.")
